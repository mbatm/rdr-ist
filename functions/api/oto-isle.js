...
SADECE şu JSON formatını döndür:
{
  ...
  "instagram": "Haberi Instagram için yeniden yaz. Kurallar: 1) 'KAYSERİ (1HA)-' gibi kaynak öneklerini kaldır, 2) Doğal akıcı dil, tek satır aralıkları kullan (çift boşluk bırakma), 3) Haberin kategorisine/konusuna uygun emoji'ler kullan (🚒🏥⚽🎓🏛️🌿💰📢 vb), 4) 1200-2000 karakter, 5) Sondan bir önce satır 'Haber detayları kayserim.net\\'te 🔗', 6) Son satırda habere uygun 6-10 hashtag (#kayseri #kayserihaber #kayserison ve konuya özel etiketler), 7) Metin içine URL veya link ekleme",
  "facebook": "Haber başlığı + özet + 1-2 cümle detay. Konuya uygun emoji ekle. Max 300 karakter. Sonuna #kayseri #kayserihaber. Site linki ayrıca eklenecek.",
  "x_twitter": "Başlık + kısa spot. Max 230 karakter. Konuya uygun 1-2 emoji. #KayseriSonDakika #Kayseri ve konuya özel 1-2 hashtag. Site linki ayrıca eklenecek.",
